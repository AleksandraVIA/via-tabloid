...
SVC_NAME="actions.runner.AleksandraVIA-via-tabloid.MacBook-Pro-Aleksandra-2"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (AleksandraVIA-via-tabloid.MacBook-Pro-Aleksandra-2)"
